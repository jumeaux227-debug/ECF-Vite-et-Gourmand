...
<div class="container py-5">
    <div class="row justify-content-center">
        <div class="col-lg-9">
            ...
            <section class="mb-4">
                <h2 class="h4 fw-bold text-dark">2. Hébergeur</h2>
                <p>Le site est hébergé par la société <strong>AlwaysData</strong>, SARL au capital de 200 000 €.</p>
                <p><strong>Siège social :</strong> 91 rue du Faubourg Saint-Honoré, 75008 Paris<br>
                <strong>Site internet :</strong> https://www.alwaysdata.com</p>
            </section>
